...
def render_sgk_system_prompt(ten: str = "bé", lop: int | str = 2) -> str:
    """Inject profile vào template. Dùng .replace() để tránh xung đột với
    dấu ngoặc nhọn JSON trong prompt."""
    return SGK_TEACHER_SYSTEM_PROMPT.replace("[TEN]", str(ten or "bé")).replace(
